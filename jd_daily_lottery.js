...
[task_local]
#每日抽奖
23 2,20,23 * * * jd_daily_lottery.js, tag=每日抽奖, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "23 2,20,23 * * *" script-path=jd_daily_lottery.js, tag=每日抽奖

====================Surge================
每日抽奖 = type=cron,cronexp="23 2,20,23 * * *",wake-system=1,timeout=3600,script-path=jd_daily_lottery.js

============小火箭=========
每日抽奖 = type=cron,script-path=jd_daily_lottery.js, cronexpr="23 2,20,23 * * *", timeout=3600, enable=true
*/
